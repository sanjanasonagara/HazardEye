...
export const Incidents: React.FC = () => {
    ...
    // Get incidents filtered by context (currently returns all, but could be restricted)
    ...
    // Reset to page 1 if itemsPerPage changes or search changes (implicit in keeping currentPage valid, but good to be explicit)
    // We handle the slice safely regardless of currentPage, but resetting is better UX.
    // Note: Since we don't have useEffect easily available without importing it (and avoiding massive refactors), 
    // we'll just ensure the slice doesn't error and maybe clamp currentPage for rendering.
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">View reported safety incidents</p>
                    </div>
                </div>
