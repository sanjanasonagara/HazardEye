...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    // Default to an employee user if possible, or fallback
        ...
        try {
            ...
            if (storedUser) {
                ...
                return {
                    ...
                    role: (parsed.role?.toLowerCase() === 'safetyofficer' || parsed.role?.toLowerCase() === 'supervisor') ? 'supervisor' : 'employee',
    ...
    const getFilteredIncidents = useCallback((): Incident[] => {
        ...
        // ... basic filtering logic if needed (Assuming employees don't filter incidents much, but keeping logic is fine)
        return filtered;
    }, [incidents]);

    const getFilteredTasks = useCallback((): Task[] => {
        // Strict enforcement: Employees ONLY see their own tasks
