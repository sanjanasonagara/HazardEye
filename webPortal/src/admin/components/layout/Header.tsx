...
const Header = () => {
    ...
    const navItems = [
        ...
        { path: '/admin/cms', name: 'Content Management System', icon: Files },
        { path: '/admin/users', name: 'User Management', icon: User },
        { path: '/admin/safety-guidelines', name: 'Safety Resources', icon: BookOpen },
        ...
        <header style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div className="profile-dropdown-container card flex-shadow" style={{ position: 'relative', paddingLeft: '1rem', borderLeft: '1px solid #334155' }}>
                        <button
