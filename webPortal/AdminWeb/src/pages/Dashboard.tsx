...
import { analyticsData, cmsContent, ioclGujaratRefineryPolygon } from '../data/mockData';
import {
                ...
                {stats.map((stat, index) => {
                    ...
                    return (
                        <div key={index} className="card" style={{
                            ...
                            <div style={{ marginTop: '0.5rem', display: 'flex', alignItems: 'center', fontSize: '1rem', position: 'relative', zIndex: 10 }}>
                                {stat.trend === 'up' ? (
